...
class RedCarpet extends LastMoveCard {
  ...
  void lastMoveCardAction(List<Player> players) {
    ...
    (Scenario.currentScenario as MafiaNightsScenario).permanentRedCarpetPlayerName = players[1].name;
    (Scenario.currentScenario as MafiaNightsScenario).redCarpetPlayerName = players[1].name;
  }

  @override
  void undoLastMoveCardAction(List<Player> players) {
    players[0].playerStatus = PlayerStatus.active;
    (Scenario.currentScenario as MafiaNightsScenario).permanentRedCarpetPlayerName = null;
    (Scenario.currentScenario as MafiaNightsScenario).redCarpetPlayerName = null;
  }
}
