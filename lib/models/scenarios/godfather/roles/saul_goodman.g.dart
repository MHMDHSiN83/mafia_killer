...
part of 'saul_goodman.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

SaulGoodman _$SaulGoodmanFromJson(Map<String, dynamic> json) => SaulGoodman()
...
Map<String, dynamic> _$SaulGoodmanToJson(SaulGoodman instance) =>
    <String, dynamic>{
      'name': instance.name,
