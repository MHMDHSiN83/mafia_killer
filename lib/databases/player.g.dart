...
const PlayerSchema = CollectionSchema(
  ...
  properties: {
    r'doesParticipate': PropertySchema(
      id: 0,
      name: r'doesParticipate',
      type: IsarType.bool,
    ),
...
extension PlayerQueryFilter on QueryBuilder<Player, Player, QFilterCondition> {
  QueryBuilder<Player, Player, QAfterFilterCondition> doesParticipateEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'doesParticipate',
        value: value,
      ));
    });
  }

  QueryBuilder<Player, Player, QAfterFilterCondition> hasListenersEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
...
extension PlayerQuerySortBy on QueryBuilder<Player, Player, QSortBy> {
  QueryBuilder<Player, Player, QAfterSortBy> sortByDoesParticipate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'doesParticipate', Sort.asc);
    });
  }

  QueryBuilder<Player, Player, QAfterSortBy> sortByDoesParticipateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'doesParticipate', Sort.desc);
    });
  }

  QueryBuilder<Player, Player, QAfterSortBy> sortByHasListeners() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hasListeners', Sort.asc);
    });
  }

  QueryBuilder<Player, Player, QAfterSortBy> sortByHasListenersDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension PlayerQuerySortThenBy on QueryBuilder<Player, Player, QSortThenBy> {
  QueryBuilder<Player, Player, QAfterSortBy> thenByDoesParticipate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'doesParticipate', Sort.asc);
    });
  }

  QueryBuilder<Player, Player, QAfterSortBy> thenByDoesParticipateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'doesParticipate', Sort.desc);
    });
  }

  QueryBuilder<Player, Player, QAfterSortBy> thenByHasListeners() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hasListeners', Sort.asc);
    });
  }

  QueryBuilder<Player, Player, QAfterSortBy> thenByHasListenersDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hasListeners', Sort.desc);
    });
  }
...
extension PlayerQueryWhereDistinct on QueryBuilder<Player, Player, QDistinct> {
  QueryBuilder<Player, Player, QDistinct> distinctByDoesParticipate() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'doesParticipate');
    });
  }

  QueryBuilder<Player, Player, QDistinct> distinctByHasListeners() {
    return QueryBuilder.apply(this, (query) {
...
extension PlayerQueryProperty on QueryBuilder<Player, Player, QQueryProperty> {
  ...
  QueryBuilder<Player, bool, QQueryOperations> doesParticipateProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'doesParticipate');
    });
  }

  QueryBuilder<Player, bool, QQueryOperations> hasListenersProperty() {
    return QueryBuilder.apply(this, (query) {
