...
void _roleSerialize(
  ...
  writer.writeBool(offsets[1], object.isInGame);
...
Role _roleDeserialize(
  ...
  object.id = id;
  object.isInGame = reader.readBool(offsets[1]);
  return object;
}
...
extension RoleQueryFilter on QueryBuilder<Role, Role, QFilterCondition> {
  ...
  QueryBuilder<Role, Role, QAfterFilterCondition> isInGameEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isInGame',
        value: value,
...
extension RoleQuerySortBy on QueryBuilder<Role, Role, QSortBy> {
  ...
  QueryBuilder<Role, Role, QAfterSortBy> sortByIsInGame() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isInGame', Sort.asc);
    });
  }

  QueryBuilder<Role, Role, QAfterSortBy> sortByIsInGameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isInGame', Sort.desc);
    });
  }
...
extension RoleQuerySortThenBy on QueryBuilder<Role, Role, QSortThenBy> {
  ...
  QueryBuilder<Role, Role, QAfterSortBy> thenByIsInGame() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isInGame', Sort.asc);
    });
  }

  QueryBuilder<Role, Role, QAfterSortBy> thenByIsInGameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isInGame', Sort.desc);
    });
  }
...
extension RoleQueryWhereDistinct on QueryBuilder<Role, Role, QDistinct> {
  ...
  QueryBuilder<Role, Role, QDistinct> distinctByIsInGame() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isInGame');
    });
  }
...
extension RoleQueryProperty on QueryBuilder<Role, Role, QQueryProperty> {
  ...
  QueryBuilder<Role, bool, QQueryOperations> isInGameProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isInGame');
    });
  }
